...
using Sample.Novel.EntityFrameworkCore.Repositories.Author;
using Sample.Novel.EntityFrameworkCore.Repositories.Book;
using Sample.Novel.EntityFrameworkCore.Repositories.Category;
